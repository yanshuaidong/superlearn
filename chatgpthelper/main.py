...
class TaskManager:
    ...
    def submit_task(self, question, timeout=300):
        ...
        Args:
            question: 问题内容
            timeout: 超时时间（秒），默认5分钟（ChatGPT可能需要更长时间）
...
if __name__ == '__main__':
    print('=' * 60)
    print('🚀 ChatGPT Helper API 服务启动')
    print('=' * 60)
    print(f'🌐 服务地址: http://127.0.0.1:1126')
    print(f'📝 回答格式: 纯文本')
    print()
    print('对外接口（供其他程序调用）:')
    ...
    print()
    print('使用示例:')
    print('  curl -X POST http://127.0.0.1:1126/ask \\')
    ...
    app.run(host='127.0.0.1', port=1126, debug=False, threaded=True)
